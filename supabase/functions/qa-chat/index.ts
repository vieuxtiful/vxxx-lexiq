...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert Quality Assurance assistant for translation projects. You help linguists make informed decisions about terminology and translation quality.
